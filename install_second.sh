...
echo ""
echo -en "${green}Enter User Agent [${cyan}Example: ${yellow}Mozilla/5.0 (Android 12; Mobile; rv:102.0) Gecko/102.0 Firefox/102.0${green}]: ${rest}"
read -r user_agent
echo -e "${purple}============================${rest}"
...
echo -en "${green}Enter the Threshold that you want to buy a new card? (${yellow}number below 1 to always buy the best card and greater than 1 to buy the second best card threshold${green}):${rest}"
read -r threshold
